-- ==============================================
-- COMPLETE ALERT SERVICE SETUP
-- ==============================================
-- This migration combines schema fixes and alert rule seeding
-- Run this after the alert service schema has been fixed
...
DO $$
BEGIN
    RAISE NOTICE '🎉 Alert rules seeded successfully!';
    ...
    RAISE NOTICE '🚀 Alert service ready for MVP testing!';
END $$;
