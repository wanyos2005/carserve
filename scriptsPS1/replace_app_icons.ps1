...
# This script helps you replace the default Flutter icons with your custom ones
...
Write-Host "🏷️  Icon name: $IconName" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "If you need to restore original icons:" -ForegroundColor Yellow
Write-Host "   Run the restore command from the scripts directory" -ForegroundColor White
