...
class ApiConfig {
  ...
  static const String baseUrl = String.fromEnvironment(
    'BASE_URL',
     defaultValue: 'http://16.16.143.243'//'http://192.168.0.105:8000'//'http://16.16.143.243', // ✅ Public AWS VM IP //if local machine :'http://192.168.0.103:8000', //if oracle: 'http://152.70.28.112', 
  );
}
//
